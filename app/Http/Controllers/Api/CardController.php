...
class CardController extends Controller
{
    ...
    /**
     * @OA\Post(
     *     path="/api/cards/login-with-parent-code",
     *     operationId="cardLoginWithParentCode",
     *     tags={"Cards"},
     *     summary="Card login with parent code",
     *     description="Authenticate a card using parent code and return full card details",
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     ...
     * )
     */
    public function loginWithParentCode(Request $request)
    {
        $request->validate([
