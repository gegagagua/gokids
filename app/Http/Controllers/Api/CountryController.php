...
class CountryController extends Controller
{
     ...
     *                     @OA\Property(property="sms_gateway_id", type="integer", example=1, description="SMS Gateway ID for this country"),
 ...
 *             @OA\Property(property="dister", type="object", nullable=true, description="Dister information",
     ...
     *             @OA\Property(property="sms_gateway_id", type="integer", example=1),
